package com.mairie.guichet.configuration.logger;

import com.mairie.guichet.security.SecurityUtils;
...
public class LogAspect {
    ...
    @Before("@annotation(com.mairie.guichet.configuration.logger.Logged)")
